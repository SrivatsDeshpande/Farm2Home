...
$sql="select * from farmer_info where username='$new_uname'  ";
...
$sql="insert into farmer_info(name,username,password,phone,address) values('$name','$new_uname','$new_pw',$phone,'$source')";
